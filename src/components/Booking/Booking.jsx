...
const Booking = ({tour, avgRating}) => {
  ...
  return (
    ...
    <div className="booking_top d-flex align-items-center justify-content-between">
       ...
       <h3><i class='BiRupee'><BiRupee/></i>{price} <span>/per person</span></h3>
            ...
            <div className='booking_bottom'>
               <ListGroup>
                  <ListGroupItem className='border-0 px-0'>
                     <h5 className='d-flex align-items-center gap-1'><i class='BiRupee'><BiRupee/></i>{price}<i class='ri-close-line'><RiCloseFill/>Per Person</i></h5>
                     <span><i class='BiRupee'><BiRupee/></i>{price}</span>
                  </ListGroupItem>
               ...
               <button className='w-100 mt-4' onClick={handleClick}>Book Now</button>
